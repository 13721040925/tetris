...
<script type="text/javascript">    
    ...
    TETRIS.Block.prototype.draw = function (opt){//绘图    
        for(var i = 0 ; i < this.shape.length ; i++){    
            ...
            T.oDomBoard.rows[oShape.y].cells[oShape.x].style.background = (opt==undefined?"yellow":"");    
        }    
    };    
...
<body>
	...
	<div id="gameControl">
		...
		<input type="button" id="btnPlay" class="easyui-linkbutton" value="开始" /> 
		<input type="button" id="btnPause" class="easyui-linkbutton" value="暂停" /><br /> 
		<span>冰山俄罗斯方块</span>
	</div>
